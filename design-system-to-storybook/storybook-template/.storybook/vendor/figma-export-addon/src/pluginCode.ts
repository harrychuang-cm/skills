...
const figmaImporterExtractionPayload = {
  ...
  tokens: [],
  version: 2,
} satisfies FigmaExportPayload;

function getFigmaImporterFunctionCode(): string {
...
export type FigmaImporterPluginMainCodeOptions = {
  height?: number;
  width?: number;
};

export function createFigmaImporterPluginMainCode(
  options: FigmaImporterPluginMainCodeOptions = {},
): string {
