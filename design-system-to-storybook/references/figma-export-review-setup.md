...
- CSS font-family fallback lists are portable: the exporter preserves the complete list in token `rawValue`, while addon 0.4.19 and importer 1.2.4 normalize Figma variable values to one loaded family and try later concrete fallbacks before Inter.
