...
- CSS font-family fallback lists are portable: the exporter preserves the complete list in token `rawValue`, while addon 0.5.0 and importer 1.3.0 normalize Figma variable values to one loaded family and try later concrete fallbacks before Inter.
