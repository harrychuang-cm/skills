# executive-presentation-skill Specification

## Purpose

Define a portable skill for Claude Code, Codex, and Cursor that turns meeting notes, source material, or a topic into a conclusion-first executive presentation with MECE supporting pillars, traceable evidence, and actionable next steps.
...
<!-- @trace
source: add-executive-presentation-skill
updated: 2026-09-14
code:
  - executive-presentation/SKILL.md
  - README.md
  - executive-presentation/agents/openai.yaml
-->
