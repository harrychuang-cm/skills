# designer-guided-automation-setup Specification

## Purpose

Define a designer-language, scenario-driven setup layer for the `agent-automation-orchestrate` skill: scenario template assets, plain-language interview rules, translation of interview answers into a valid project contract without exposing internals, and glossary-based status reporting for a designer audience.
